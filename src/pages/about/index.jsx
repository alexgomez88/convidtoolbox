...
const About = () => (
  <section className="page about-page">
    ...
    <h1>Sobre GlobalMaikan</h1>
    <p>
      GlobalMaikan es una iniciativa de desarrollo de software que busca
      solucionar problemas del profesional e industrial mediante estrategias de
      alta mantenibilidad. La iniciativa se extiende a actividades de desarrollo
      de aplicaciones de escritorio, aplicaciones moviles, automatización y
      formación. Para más información consulta www.globalmaikan.com.ve.
    </p>
  </section>
);
